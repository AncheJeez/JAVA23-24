...
public class Programador extends Empleado{
    ...
    // programador auxiliar, para que podamos obtener los datos expecificos sin introducir el resto del empleado
    public Programador(double sueldoExtra, String lengProgFav){
        super(0);// esto da iwal por q no lo vamos a usar
        this.sueldoExtra = sueldoExtra;
        this.lengProgFav = lengProgFav;
    }
