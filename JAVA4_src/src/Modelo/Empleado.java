...
public abstract class Empleado implements Fecha, Serializable{
    ...
    public Empleado(int givenNumber, String givenName, String givenApellido, double givenSaldo, double givenSaldoMax){
        ...
        //!!!!! ESTA EXCEPCION FUNCIONABA EN MODO TERMINAL, PERO EN LA VISTA AL LANZAR LA EXCEPCION NO ENTRABA EN EL JDIALOG,
        // ASI QUE LA EXCEPCION SE ENCUENTRA EN LA VISTA, ES DECIR, DEJA CREAR UN OBJETO PERO NO SE AÑADE A LA PROPIA LISTA
        ...
        try{
            if(givenSaldo <= givenSaldoMax){
                ...
                throw new CustomException("CUSTOM EXCEP: SaldoMaximo introducido es menor al saldo dado en el empleado nº"+getNumero());
            }
