...
//POR HACER
/*
HECHO :DDDD CUANDO MODIFICO UN EMPLEADO LA FECHA SE ACTUALIZA A LA ACTUAL, NO DEBE OCURRIR
HECHO :DDDD EL BOTON SIGUIENTE AL MOSTRAR CON FILTRO SIEMPRE APARECE AUNQUE SEA UNO SOLO EL QUE TENGA ESA FECHA
HECHO :DDDD HACER QUE NO SEA MODIFICABLE LAS BOXES SI NO ESTA EL PROGRAMA EN MODO CREAR O MODIFICAR
*/
...
//        }
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if(createState == false){
            ...
            if(txNumero.getText().isEmpty()){
                ...
                Empleado newEmpleado = getInfoFromCurrentBoxes(false);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if(modifyState == false){
            ...
            Empleado modifiedEmpleado = getInfoFromCurrentBoxes(true);
    ...
    private void filterComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filterComboBoxActionPerformed
        ...
        if (filterDate != null && !filterDate.equals("SHOW ALL")) {
            ...
            fillBoxes(listaEmpleados);
            // como va a enseñar el primero de esta nueva lista, no hay anterior
            if(listaEmpleados.getCont()<=1)
                btnSiguiente.setEnabled(false);
            else
                btnSiguiente.setEnabled(true);
            btnAnterior.setEnabled(false);
            // estos botones los tengo desabilitados durante el filtro
            btnCrear.setEnabled(false);
            btnModificar.setEnabled(false);
            btnBorrar.setEnabled(false);
            isFiltered = true;
    ...
    public void setBoxesEditable(boolean typeOfEditable){
        txApellido.setEditable(typeOfEditable);
        txFechaAlta.setEditable(typeOfEditable);
        txNombre.setEditable(typeOfEditable);
        txNumero.setEditable(typeOfEditable);
        txSaldo.setEditable(typeOfEditable);
    }
    
    // el boolean representa si queremos pillar la fecha o introducir una nueva de hoy
    public Empleado getInfoFromCurrentBoxes(boolean withDate){
        int numero;
        String nombre;
        String apellido;
        double saldo;
        ...
        if(withDate){
            Empleado aux = (Empleado)listaEmpleados.getPointerActual().getMain();
            Empleado newEmpleado = new Empleado(numero,nombre,apellido,saldo,aux.getFechaAlta());
            return newEmpleado;
        }else{
