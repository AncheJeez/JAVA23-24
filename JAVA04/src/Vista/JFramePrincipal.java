...
public class JFramePrincipal extends javax.swing.JFrame {
    ...
    public void addFromFileToList(MyList listaFromFile){
        ...
        if(!listaEmpleados.isEmpty()){
            lastIndex = listaEmpleados.getPointerLast().getIndice();
        }
        do{
            lastIndex++;
            // añadimos a la lista principal
            listaEmpleados.add(listaFromFile.getCurrentNode().getMain());
            listaEmpleados.getPointerLast().setIndice(lastIndex);
            // avanzamos
    ...
    public void swapBotonPanelCrearMenu(){
